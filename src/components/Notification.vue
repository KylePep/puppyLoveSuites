<template>
  ...
  <div v-if="!dismiss" class="col-12 bg-success rounded px-4 py-2 text-white">
    ...
    <div class="d-flex justify-content-between">
      ...
      <i @click="setDismiss()" class="dismiss mdi mdi-close "></i>
    ...
    <p class="mb-0">
      ...
      take a work trip. Puppy Love Suites- love and play with every stay
    </p>
